                    ...
                    <div className="container about">
                        <div className="row">
                            <div className="col-lg-4" style={{ marginBottom: '40px' }}>
                                ...
                                from top to bottom with input from our Back-end Lead,&nbsp;
                            <a style={{ color: 'rgb(34, 97, 83)' }} href="https://www.linkedin.com/in/johnswong14/">Johnson Wong</a>.
                                                            Here is the&nbsp;
                            ...
                            <a style={{ color: 'rgb(34, 97, 83)' }} href="https://github.com/turbosmr/TankGame">Github Link</a>.
                            </p>
                                <hr style={{ borderWidth: 2 }} />
                                <p>Features:</p>
                                <ul>
                            ...
                            <div className="col-lg-4" style={{ marginBottom: '40px' }}>
                                ...
                                <p style={{ marginTop: '0px' }}>
                                    This was my second video game that I made for CSC 413 at SFSU, coded in Java.
                                     I reused a lot of the code from my tank game. Here's the&nbsp;
                            <a style={{ color: 'rgb(34, 97, 83)' }} href="https://github.com/turbosmr/BrickBreakerGame">Github Link</a>.
                            </p>
                                <hr style={{ borderWidth: 2 }} />
                                <p>Features:</p>
                                <ul>
